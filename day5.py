...
for i in range(len(data)):
    ...
    while(j<=num_cargo):
        ...
        if(final_stack==1):stack1.append(ele)
        if(final_stack==2):stack2.append(ele)
        if(final_stack==3):stack3.append(ele)
        if(final_stack==4):stack4.append(ele)
        if(final_stack==5):stack5.append(ele)
        if(final_stack==6):stack6.append(ele)
        if(final_stack==7):stack7.append(ele)
        if(final_stack==8):stack8.append(ele)
        if(final_stack==9):stack9.append(ele)
        j = j+1
